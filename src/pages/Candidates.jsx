          ...
          <table className="min-w-[1200px] w-full table-auto">
            <thead className="bg-slate-50">
              <tr className="text-left">
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Candidato</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Email</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Teléfono</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Ubicación</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Senior</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Años</th>
                <th className="px-4 py-3 text-xs font-semibold text-slate-600">Skills</th>
            ...
            <tbody className="divide-y divide-slate-200">
              <tr className="hover:bg-slate-50 transition-colors">
                <td className="px-4 py-3">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-slate-900 truncate">Ana Martínez</p>
                    <p className="mt-0.5 text-xs text-slate-500 truncate">ID: 1</p>
                  </div>
                </td>
                <td className="px-4 py-3">
                  <p className="text-sm text-slate-700 whitespace-nowrap">ana.martinez@gmail.com</p>
                </td>
                <td className="px-4 py-3">
                  <p className="text-sm text-slate-700 whitespace-nowrap">+57 301 555 0101</p>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3">
                  <p className="text-sm text-slate-700 whitespace-nowrap">1</p>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3">
                  <p className="text-sm text-slate-700 whitespace-nowrap">45</p>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3">
                  <p className="text-sm text-slate-700 whitespace-nowrap">2026-03-01T09:00:00.000Z</p>
                </td>
                <td className="px-4 py-3">
